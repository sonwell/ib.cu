...
namespace util {
	...
	private:
		...
		virtual bool
		do_is_equal(const static_memory_resource& other)
		{
			return *parent_resource == *(other.parent_resource) &&
				memory == other.memory;
		}
	...
	namespace detail {
		using memory_resource_pointer = memory_resource*;
		inline memory_resource_pointer&
