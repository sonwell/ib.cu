...
#define codes(transform) \
			...
			transform(NOT_INITIALIZED, "cusolver library initialization failed") \
			...
			transform(INVALID_LICENSE, "invalid license") \
...
#define message_transform(type, string) \
				case CUSOLVER_STATUS_##type: return string;
...
#undef codes
	...
	inline bool is_success(status_t e) { return e == CUSOLVER_STATUS_SUCCESS; }
