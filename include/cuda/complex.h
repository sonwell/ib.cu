...
template <typename base_type>
	constexpr base_type abs(const complex<base_type>&);
template <typename base_type>
...
public:
	...
	constexpr complex(const complex& z) : base(z) {}
	template <typename other_base>
